...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::browser_commands::browser_stitch_captures,
            commands::browser_commands::browser_bridge_event,
            commands::browser_commands::browser_send_bridge_message,
            ...
            commands::simulator_commands::simulator_list_devices,
            commands::simulator_commands::simulator_boot,
            commands::simulator_commands::simulator_screenshot,
            commands::simulator_commands::simulator_open_surface,
            commands::simulator_commands::simulator_close_surface,
            ...
            commands::repository_commands::load_repo_copy_settings,
            commands::repository_commands::update_repo_copy_settings,
            commands::repository_commands::detect_repo_copy_candidates,
            ...
            commands::system_commands::read_clipboard_image,

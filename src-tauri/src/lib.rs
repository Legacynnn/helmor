...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::forge_commands::list_github_issue_timeline,
            commands::forge_commands::set_github_issue_assignees,
            commands::forge_commands::set_github_issue_labels,
            commands::forge_commands::set_github_issue_milestone,
            commands::forge_commands::set_github_issue_type,
            commands::forge_commands::list_github_assignable_users,
            commands::forge_commands::list_github_repo_labels,
            commands::forge_commands::list_github_milestones,
            commands::forge_commands::list_github_issue_types,
            ...
            commands::github_list_commands::github_list_repo_issues,
            ...
            commands::tasks_workspace_commands::tasks_find_workspace_for_linear_task,
            commands::tasks_workspace_commands::tasks_find_workspace_for_pr_url,
            commands::tasks_workspace_commands::tasks_set_workspace_linear_task,
